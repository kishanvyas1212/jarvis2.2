# # GUI of jarvis using python tkinter
# from tkinter import  *
...
#     if monitors:
#         # Assuming there's only one monitor, you can access the first item in the list
#         monitor = monitors[0]
#         width = monitor.width
...
# window.title('JARVIS')
# window.minsize(width=int(width/3),height=int(height/3))
# window.maxsize(width=width,height=height)
# l1 = Label(window,text='JARVIS',fg='red',width=50,font=100)
# # l1.pack()
# # l1.grid(row=4,column=4)
# l1.place(x=int((width/2)-200),y=int(height/2-20))
# window.mainloop()
