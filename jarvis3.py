    ...
    def check_emails(self):
        while True:
            try:
                ...
                # For demonstration purposes, we'll print a message when an important email is received
                print("Checking emails...")
            except Exception as e:
                print("Error:", e)
            
            # Wait for 10 minutes before checking emails again
            time.sleep(600)
...
class Mainthread(QThread):
    ...
    def Taskexecution(self):
        startup()
        self.email_checker = EmailChecker(obj)
        self.email_thread = threading.Thread(target=self.email_checker.check_emails)
        ...
        while True:
            ...
            if "let's start" in query or 'start work' in query:
                ...
                while loop:
                    ...
                    elif re.search('what is date today', command):
                    ...
                    #     get_weather(command)
                        ...
                        if app_name != 'none':
                            ...
                            if 'yes' in des or 'definitely' in des:
                                find_app(app_name, obj.find_apps)
                            else:
    ...
    def stop_email_thread(self):
        self.email_checker.stop()
...
class GUI(QMainWindow):
    ...
    def closeEvent(self, event):
        # Override the closeEvent method to stop the email thread before closing the application
        self.startjarvis.stop_email_thread()
        event.accept()
